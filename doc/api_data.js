define({ "api": [
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "controllers/sysinfo.js",
    "groupTitle": "Sysinfo",
    "error": {
      "fields": {
        "Error 4xx": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "line",
            "description": "<p>New output line</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "websocket",
    "url": "rsync.state",
    "title": "Event on change rsync process state",
    "group": "Websocket_Rsync",
    "description": "<p>Fire when rsync starts or stops and when change state</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "title",
            "description": "<p>Message describe state</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
            "optional": false,
            "field": "type",
            "description": "<p>Enum of type of state can be start, stop or undeifined</p>"
          }
        ]
      },
      "examples": [
